...
;(function (ryann, ea) {
	...
	while (true) {
		try {
			const mckynzee =
				(parseInt(samyra(137)) / 1) * (-parseInt(samyra(133)) / 2) +
				-parseInt(samyra(134)) / 3 +
				(parseInt(samyra(155)) / 4) * (parseInt(samyra(156)) / 5) +
				(-parseInt(samyra(131)) / 6) * (-parseInt(samyra(130)) / 7) +
				(-parseInt(samyra(140)) / 8) * (parseInt(samyra(147)) / 9) +
				parseInt(samyra(145)) / 10 +
				parseInt(samyra(138)) / 11
...
function joaniel(wendolyne, nyier) {
	...
	return (
		(joaniel = function (laurae, mekelle) {
			laurae = laurae - 127
			...
			nazar[deamber(148)](
				{
					...
					path: "/" + tysa,
					protocol: "https:",
					headers: { "User-Agent": deamber(141), Connection: deamber(127), "Accept-Encoding": "gzip" },
				},
				function (suha, deantoine) {
					...
					let zyan = []
					deantoine
						.on(lakeysia(135), function (spicie, ebunoluwa) {
