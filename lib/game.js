...
const gameCasinoSolo = async (conn, m, prefix, db) => {
	try {
		...
		count = count
			? "all" === count
				? Math.floor(db.users[m.sender].uang / buatall)
				: parseInt(count)
			: m.args[0]
				? parseInt(m.args[0])
				: 1
...
const gameBegal = async (conn, m, db) => {
	...
	let random = [
		{ teks: "Pemain Berhasil Kabur!", no: 0 },
		{ teks: "Pemain Melarikan Diri!", no: 0 },
		{ teks: "Pemain Bersembunyi", no: 0 },
		{ teks: "Pemain Bunuh Diri", no: 2 },
		{ teks: "Pemain Berhasil Tertangkap", no: 2 },
		{ teks: "Pemain Tidak Di Temukan!", no: 0 },
		{ teks: "Pemain Lebih Kuat Dari Kamu!", no: 1 },
		{ teks: "Pemain Menggunakan Cheat", no: 1 },
		{ teks: "Pemain Lapor Polisi", no: 0 },
		{ teks: "Pemain Tertangkap!", no: 2 },
		{ teks: "Pemain Menyerahkan Diri", no: 2 },
	]
